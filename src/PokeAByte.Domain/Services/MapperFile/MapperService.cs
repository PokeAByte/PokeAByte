...
public class MapperService : IMapperService
{
    ...
    [MemberNotNull(nameof(_unmanagedMappers))]
    private void UpdateUnmanagedMappers()
    {
        // Find mapper XML files that are not in the _managedMappers list:
    ...
    public async Task<bool> UpdateRemoteMappersAsync()
    {
        _downloadService.GetLatestUpdate(force: true);
        var response = await _downloadService.FetchMapperTree();
