export function postprocessor() {
	...
	const int16 = __memory.defaultNamespace.get_bytes(0, 2).get_uint16_le(0);
	const int32 = __memory.defaultNamespace.get_bytes(0, 6).get_uint32_le(2);
	const int64 = __memory.defaultNamespace.get_bytes(0, 14).get_uint64_le(6);
	...
	const directInt16 = __memory.defaultNamespace.get_uint16_le(0);
	const directInt32 = __memory.defaultNamespace.get_uint32_le(2);
	const directInt64 = __memory.defaultNamespace.get_uint64_le(6);
