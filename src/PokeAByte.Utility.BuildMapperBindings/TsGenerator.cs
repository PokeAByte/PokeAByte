...
public static class TsGenerator
{
            ...
            case "property":
                {
                    ...
                    if (string.IsNullOrEmpty(referenceType) == false)
                    {
                        ...
                        {
                            return "PokeAByteProperty<string>";
                        }
                        else if (referenceNodeType == "number")
                        {
                            return "PokeAByteProperty<number>";
                        }
                        else
                        {
                            throw new Exception(
                    ...
                    if (attributeType == "binaryCodedDecimal") return "PokeAByteProperty<number>";
                    else if (attributeType == "bitArray") return "PokeAByteProperty<boolean[]>";
                    else if (attributeType == "bit") return "PokeAByteProperty<boolean>";
                    else if (attributeType == "bool") return "PokeAByteProperty<boolean>";
                    else if (attributeType == "int") return "PokeAByteProperty<number>";
                    else if (attributeType == "string") return "PokeAByteProperty<string>";
                    else if (attributeType == "uint") return "PokeAByteProperty<number>";
                    else if (attributeType == "nibble") return "PokeAByteProperty<number>";
    ...
    public static string FromMapper(string contents)
    {
        ...
        result.AppendLine("import { AbstractMapperClient, PokeAByteProperty } from \"../index.js\"");

        result.AppendLine(string.Empty);

        // References
        var references = PokeAByteMapperXmlFactory.GetGlossary(doc);
