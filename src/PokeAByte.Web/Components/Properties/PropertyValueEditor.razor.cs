...
public partial class PropertyValueEditor
{
    ...
    {
        var glossaryResult = MapperConnectionService.GetGlossaryByReferenceKey(reference);
    ...
    {
        var result = await MapperConnectionService.UpdatePropertyData(EditContext.Path,
