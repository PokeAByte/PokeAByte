...
public static class PokeAByteIcons
{
    public const string SnowflakeIconDisabled = 
        """
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-snowflake" width="24" height="24"
    ...
    public const string SnowflakeIcon = 
        """
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-snowflake" width="24" height="24"
