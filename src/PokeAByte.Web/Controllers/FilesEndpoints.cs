...
public static class FilesEndpoints
{
        ...
        IMapperService mapperService)
    {
        return mapperService
            .ListArchived()
            .GroupBy(archive => archive.Path)
            .Select(archive => new KeyValuePair<string, IEnumerable<ArchivedMapperFile>>(archive.Key, archive))
            .ToDictionary();
    }
    ...
    public static Task<bool> CheckForUpdatesAsync(IMapperService mapperService)
        => mapperService.UpdateRemoteMappersAsync();
